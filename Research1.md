File upload seems to have issues with MIME type detection. Let me send the research document as a message attachment instead. The full markdown content is below:
